...
This document is the dedicated integration plan for the redesigned attendance system. It ties together authentication, timetable validation, section isolation, realtime fan-out, and audit logging so the full flow works end to end without frontend changes.
